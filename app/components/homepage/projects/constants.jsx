export const projectImages = {
  1: [
    // Audio Deepfake Detection System - Images only
    {
  ...
  5: [
    ...
    },
    {
      ...
      alt: "EV Charging Station Home Page",
      caption:
        "The main home page of the EV charging station app, providing an overview of available services and navigation options.",
    },
    {
      src: "/ProjectPics/EVchargingStation/NavBar.jpg",
      alt: "Navigation Bar Interface",
      caption:
        "The navigation bar interface showing various menu options and user navigation elements within the EV charging station app.",
    },
    {
      src: "/ProjectPics/EVchargingStation/Payments.jpg",
      alt: "Payment Processing Interface",
      caption:
        "The payment processing screen where users can manage their payment methods and complete transactions for charging sessions.",
    },
  ],
  7: [
    // 2D Platform Game - Images only
    {
...
// Separate constants for video content
export const projectVideos = {
  1: [
    // Audio Deepfake Detection System - Video
    {
